            ...
            <tbody>
              {patients.length === 0 ? (
                ...
                <tr key={patient.id}>
                  ...
                  <td>
                    <ButtonGroup>
                      <Link to={"/patient/"+patient.id}><Button size="sm" variant="primary"><FontAwesomeIcon icon={faEdit}> Edit </FontAwesomeIcon></Button></Link>{' '}
                      <Button size="sm" variant="danger" onClick={deletePatient.bind(this,patient.id)}><FontAwesomeIcon icon={faTrash}> Delete </FontAwesomeIcon></Button>
                    </ButtonGroup>
                  </td>
                </tr>
                )
